...
/**
 * Test for /transaction/{transactionId}
 */
Test('/transaction/{transactionId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test getTransaction get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/transaction/{transactionId}']['get']['responses']['200']['schema']);
